...
if __name__ == "__main__":
    #print(get_movie_genres("challengers"))
    #print(get_movie_release_date("challengers"))
    #print(get_movie_cast_list("challengers"))
    #print(get_movie_streaming_services("challengers"))
    #print(get_movie_reviews("challengers"))
    #print(get_person_credits("chuck jones"))
    #print(get_movie_summary("challengers"))
    #print(get_similar_movies("challengers"))
    pass
